...
class CauHinhChung(models.Model):
    phantramthuong = models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Phần trăm thưởng', default=1.2)

    class Meta:
        verbose_name_plural = 'Cấu hình'
